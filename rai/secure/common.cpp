...
char const *test_public_key_data = "B0311EA55708D6A53C75CDBF88300259C6D018522FE3D4D0A242E431F9E8B6D0"; // viablock_3e3j5tkog48pnny9dmfzj1r16pg8t1e76dz5tmac6iq689wyjfpiij4txtdo
char const *beta_public_key_data = "A59A47CC4F593E75AE9AD653FDA9358E2F7898D9ACC8C60E80D0495CE20FBA9F"; // viablock_3betaz86ypbygpqbookmzpnmd5jhh4efmd8arr9a3n4bdmj1zgnzad7xpmfp
char const *live_public_key_data = "E89208DD038FBB269987689621D52292AE9C35941A7484756ECCED92A65093BA"; // viablock_3t6k35gi95xu6tergt6p69ck76ogmitsa8mnijtpxm9fkcm736xtoncuohr3
char const *test_genesis_data = R"%%%({
	"type": "open",
	"source": "B0311EA55708D6A53C75CDBF88300259C6D018522FE3D4D0A242E431F9E8B6D0",
	"representative": "viablock_3e3j5tkog48pnny9dmfzj1r16pg8t1e76dz5tmac6iq689wyjfpiij4txtdo",
	"account": "viablock_3e3j5tkog48pnny9dmfzj1r16pg8t1e76dz5tmac6iq689wyjfpiij4txtdo",
...
char const *beta_genesis_data = R"%%%({
        ...
        "representative": "viablock_3betaz86ypbygpqbookmzpnmd5jhh4efmd8arr9a3n4bdmj1zgnzad7xpmfp",
        "account": "viablock_3betaz86ypbygpqbookmzpnmd5jhh4efmd8arr9a3n4bdmj1zgnzad7xpmfp",
...
char const *live_genesis_data = R"%%%({
	...
	"representative": "viablock_3t6k35gi95xu6tergt6p69ck76ogmitsa8mnijtpxm9fkcm736xtoncuohr3",
	"account": "viablock_3t6k35gi95xu6tergt6p69ck76ogmitsa8mnijtpxm9fkcm736xtoncuohr3",
...
rai::keypair::keypair(rai::raw_key &&prv_a) : prv(std::move(prv_a))
{
	ed25519_publickey(prv.data.bytes.data(), pub.bytes.data());
}
...
rai::account_info::account_info() : head(0),
																		rep_block(0),
																		open_block(0),
																		balance(0),
																		modified(0),
...
rai::account_info::account_info(rai::block_hash const &head_a, rai::block_hash const &rep_block_a, rai::block_hash const &open_block_a, rai::amount const &balance_a, uint64_t modified_a, uint64_t block_count_a, rai::epoch epoch_a) : head(head_a),
...
rai::block_counts::block_counts() : send(0),
																		receive(0),
																		open(0),
																		change(0),
																		state_v0(0),
...
rai::pending_info::pending_info() : source(0),
																		amount(0),
																		epoch(rai::epoch::epoch_0)
{
}

rai::pending_info::pending_info(rai::account const &source_a, rai::amount const &amount_a, rai::epoch epoch_a) : source(source_a),
																																																								 amount(amount_a),
																																																								 epoch(epoch_a)
{
}
...
rai::pending_key::pending_key() : account(0),
																	hash(0)
{
}

rai::pending_key::pending_key(rai::account const &account_a, rai::block_hash const &hash_a) : account(account_a),
																																															hash(hash_a)
{
}
...
rai::block_info::block_info() : account(0),
																balance(0)
{
}

rai::block_info::block_info(rai::account const &account_a, rai::amount const &balance_a) : account(account_a),
																																													 balance(balance_a)
{
}
...
rai::vote::vote(rai::vote const &other_a) : sequence(other_a.sequence),
...
rai::vote::vote(rai::account const &account_a, rai::raw_key const &prv_a, uint64_t sequence_a, std::shared_ptr<rai::block> block_a) : sequence(sequence_a),
																																																																			blocks(1, block_a),
																																																																			account(account_a),
...
rai::vote::vote(rai::account const &account_a, rai::raw_key const &prv_a, uint64_t sequence_a, std::vector<rai::block_hash> blocks_a) : sequence(sequence_a),
																																																																				account(account_a)
{
...
rai::vote_uniquer::vote_uniquer(rai::block_uniquer &uniquer_a) : uniquer(uniquer_a)
{
}
